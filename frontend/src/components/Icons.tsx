...
export const BrainIcon = ({ className = "w-6 h-6", size }: IconProps) => (
  ...
  >
    ...
    <path d="M12 6v12" />
    <path d="M8 10c0-1.5 1-2.5 2-2.5s2 1 2 2.5v4c0 1.5-1 2.5-2 2.5s-2-1-2-2.5z" />
    <path d="M12 10c0-1.5 1-2.5 2-2.5s2 1 2 2.5v4c0 1.5-1 2.5-2 2.5s-2-1-2-2.5z" />
  </svg>
);

export const CalculatorIcon = ({ className = "w-6 h-6", size }: IconProps) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 24 24"
    fill="none"
...
export const BookOpenIcon = ({ className = "w-6 h-6", size }: IconProps) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 24 24"
    fill="none"
...
export const ClipboardListIcon = ({ className = "w-6 h-6", size }: IconProps) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 24 24"
    fill="none"
...
export const CheckShieldIcon = ({ className = "w-6 h-6", size }: IconProps) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 24 24"
    fill="none"
...
export const BanIcon = ({ className = "w-6 h-6", size }: IconProps) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 24 24"
    fill="none"
...
export const InfoIcon = ({ className = "w-6 h-6", size }: IconProps) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 24 24"
    fill="none"
...
export const SparklesIcon = ({ className = "w-6 h-6", size }: IconProps) => (
  <svg
    ...
    style={size ? { width: size, height: size } : undefined}
  >
    <path d="M12 3v1m0 16v1m9-9h-1M4 12H3m15.364-6.364l-.707.707M6.343 17.657l-.707.707m0-12.728l.707.707m12.022 12.022l-.707.707M12 8a4 4 0 1 0 0 8 4 4 0 0 0 0-8z" />
  </svg>
);
...
export const RotateCwIcon = ({ className = "w-6 h-6", size }: IconProps) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 24 24"
    fill="none"
